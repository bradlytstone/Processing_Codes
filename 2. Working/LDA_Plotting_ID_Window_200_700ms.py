...
#x_values = (mean_val_licl,mean_val_saline)
...
#lt.bar(y_pos, x_values, yerr=yerr, color = ['blue','green'])
...
#Save output
plt.savefig('Identity_LDA_Bar_ID_Window_nox_title.png', bbox_inches = 'tight')
plt.close('all')