...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul 10 14:16:49 2018
...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul  9 15:49:50 2018
...
yerr = (SEM_licl,SEM_healthy)

#Indicate objects for x-axis
objects = ('LiCl', 'Control')
y_pos = [1,2]

#objects = ['LiCl', 'Saline', 'Healthy']
x_values = [mean_val_licl,mean_val_healthy]

#Plot data
plt.figure()
plt.bar(y_pos, x_values, yerr=yerr, color = ['blue','green'])
...
#Save output
plt.savefig('Identity_LDA_Bar_ID_Window_2Cond_notitlex.png', bbox_inches = 'tight')
plt.close('all')