PP = xlsread('Pre_P_(N=5).xlsx');
EP = xlsread('Early_P_(N=5).xlsx');
LP = xlsread('Late_P_(N=5).xlsx');
Freq = xlsread('Frequencies.xlsx');
...
pre_0_0_avg = pre_p_1(33,:)/10^6; pre_fit_0_0 = fit(pre_f_1.',pre_0_0_avg.','smoothingspline'); early_0_0_avg = early_p_1(33,:)/10^6; early_fit_0_0 = fit(early_f_1.',early_0_0_avg.','smoothingspline');
late_0_0_avg = late_p_1(33,:)/10^6; late_fit_0_0 = fit(late_f_1.',late_0_0_avg.','smoothingspline');
...
hold on; ymax = max([pre_p_1(length(pre_p_1(:,1)),:)/10^6,early_p_1(length(early_p_1(:,1)),:)/10^6,late_p_1(length(late_p_1(:,1)),:)/10^6]); xlabel('Frequency (Hz)');ylabel('Power Spectral Density (mV^{2}/Hz)'); axis([0 xmax 0 ymax]); hold on; title('0 - 0'); hold on;
...
pre_500_0_avg = pre_p_2(33,:)/10^6; pre_fit_500_0 = fit(pre_f_2.',pre_500_0_avg.','smoothingspline'); early_500_0_avg = early_p_2(33,:)/10^6; early_fit_500_0 = fit(early_f_2.',early_500_0_avg.','smoothingspline');
late_500_0_avg = late_p_2(33,:)/10^6; late_fit_500_0 = fit(late_f_2.',late_500_0_avg.','smoothingspline');
...
hold on; ymax = max([pre_p_2(length(pre_p_2(:,1)),:)/10^6,early_p_2(length(early_p_2(:,1)),:)/10^6,late_p_2(length(late_p_2(:,1)),:)/10^6]); xlabel('Frequency (Hz)');ylabel('Power Spectral Density (mV^{2}/Hz)'); axis([0 xmax 0 ymax]); hold on; title('500 - 0'); hold on;
hLines = findobj(gca); hLines(1).Color= 'white'; hLines(2).Color = 'black';hLines(3).Color = [0,0,0,0];hLines(4).Color = 'red';hLines(5).Color = [0,0,0,0];hLines(6).Color = 'blue'; hLines(7).Color = [0,0,0,0]; hold on;
legend([p1(2), p2(2), p3(2)],'Pre-taste (-750ms,-250ms)','Early taste (250ms,750ms)','Late taste (1250ms,1750ms)','Location','northeast')

pre_500_700_avg = pre_p_3(33,:)/10^6; pre_fit_500_700 = fit(pre_f_3.',pre_500_700_avg.','smoothingspline'); early_500_700_avg = early_p_3(33,:)/10^6; early_fit_500_700 = fit(early_f_3.',early_500_700_avg.','smoothingspline');
late_500_700_avg = late_p_3(33,:)/10^6; late_fit_500_700 = fit(late_f_3.',late_500_700_avg.','smoothingspline');
...
hold on; ymax = max([pre_p_3(length(pre_p_3(:,1)),:)/10^6,early_p_3(length(early_p_3(:,1)),:)/10^6,late_p_3(length(late_p_3(:,1)),:)/10^6]); xlabel('Frequency (Hz)');ylabel('Power Spectral Density (mV^{2}/Hz)'); axis([0 xmax 0 ymax]); hold on; title('500 - 700'); hold on;
hLines = findobj(gca); hLines(1).Color= 'white'; hLines(2).Color = 'black';hLines(3).Color = [0,0,0,0];hLines(4).Color = 'red';hLines(5).Color = [0,0,0,0];hLines(6).Color = 'blue'; hLines(7).Color = [0,0,0,0]; hold on;
legend([p1(2), p2(2), p3(2)],'Pre-taste (-750ms,-250ms)','Early taste (250ms,750ms)','Late taste (1250ms,1750ms)','Location','northeast')

pre_500_1400_avg = pre_p_4(33,:)/10^6; pre_fit_500_1400 = fit(pre_f_4.',pre_500_1400_avg.','smoothingspline'); early_500_1400_avg = early_p_4(33,:)/10^6; early_fit_500_1400 = fit(early_f_4.',early_500_1400_avg.','smoothingspline');
late_500_1400_avg = late_p_4(33,:)/10^6; late_fit_500_1400 = fit(late_f_4.',late_500_1400_avg.','smoothingspline');
...
hold on; ymax = max([pre_p_4(length(pre_p_4(:,1)),:)/10^6,early_p_4(length(early_p_4(:,1)),:)/10^6,late_p_4(length(late_p_4(:,1)),:)/10^6]); xlabel('Frequency (Hz)');ylabel('Power Spectral Density (mV^{2}/Hz)'); axis([0 xmax 0 ymax]); hold on; title('500 - 1400');
hLines = findobj(gca); hLines(1).Color= 'white'; hLines(2).Color = 'black';hLines(3).Color = [0,0,0,0];hLines(4).Color = 'red';hLines(5).Color = [0,0,0,0];hLines(6).Color = 'blue'; hLines(7).Color = [0,0,0,0]; hold on;
legend([p1(2), p2(2), p3(2)],'Pre-taste (-750ms,-250ms)','Early taste (250ms,750ms)','Late taste (1250ms,1750ms)','Location','northeast')
